...
function cadastrarDespesa() {
	...
	if (despesa.validarDados()) {
        ...
        document.getElementById('modal_texto').innerHTML = 'O registro foi inserido corretamente'
        document.getElementById('modal_botao').innerHTML = 'Voltar'
        document.getElementById('modal_botao').className = 'btn btn-outline-success'
        ...
        document.getElementById('modal_texto').innerHTML = 'Todos os campos devem ser preenchidos corretamente'
        document.getElementById('modal_botao').innerHTML = 'Voltar e corrigir'
        document.getElementById('modal_botao').className = 'btn btn-outline-danger'
